...
const panels = {
  train1: {
    ...
    html: `
      <div class="dp-content">
        <div class="dp-header"><div><div class="dp-title-row"><div class="dp-icon" style="background:#e3f2fd">🚄</div><div class="dp-title">Paris → Lyon</div></div><div class="dp-subtitle">A/R · 2nde</div></div><div class="dp-price-box"><div class="dp-price-big">290 €</div><div class="dp-price-info">97 €/p · 3 voy.</div></div></div>
  ...
  'train1-1ere': {
    ...
    html: `
      <div class="dp-content">
        <div class="dp-header"><div><div class="dp-title-row"><div class="dp-icon" style="background:#e3f2fd">🚄</div><div class="dp-title">Paris → Lyon</div></div><div class="dp-subtitle">A/R · 1ère Classe</div></div><div class="dp-price-box"><div class="dp-price-big">459 €</div><div class="dp-price-info">153 €/p · 3 voy.</div></div></div>
        <div class="dp-section"><div class="dp-section-title">Itinéraire</div>
  ...
  train2: {
    ...
    html: `
      <div class="dp-content">
        <div class="dp-header"><div><div class="dp-title-row"><div class="dp-icon" style="background:#e8f5e9">🚄</div><div class="dp-title">Paris → Lyon</div></div><div class="dp-subtitle">A/R</div></div><div class="dp-price-box"><div class="dp-price-big">196 €</div><div class="dp-price-info">65 €/p · 3 voy.</div></div></div>
        <div class="dp-section"><div class="dp-section-title">Itinéraire</div>
  ...
  train3: {
    ...
    html: `
      <div class="dp-content">
        <div class="dp-header"><div><div class="dp-title-row"><div class="dp-icon" style="background:#e3f2fd">🚄</div><div class="dp-title">Paris → Lyon</div></div><div class="dp-subtitle">A/R · 2nde</div></div><div class="dp-price-box"><div class="dp-price-big">318 €</div><div class="dp-price-info">106 €/p · 3 voy.</div></div></div>
        <div class="dp-section"><div class="dp-section-title">Itinéraire</div>
  ...
  'train3-1ere': {
    ...
    html: `
      <div class="dp-content">
        <div class="dp-header"><div><div class="dp-title-row"><div class="dp-icon" style="background:#e3f2fd">🚄</div><div class="dp-title">Paris → Lyon</div></div><div class="dp-subtitle">A/R · 1ère Classe</div></div><div class="dp-price-box"><div class="dp-price-big">495 €</div><div class="dp-price-info">165 €/p · 3 voy.</div></div></div>
        <div class="dp-section"><div class="dp-section-title">Itinéraire</div>
  ...
  flight1: {
    ...
    html: `
      <div class="dp-content">
        <div class="dp-header"><div><div class="dp-title-row"><div class="dp-icon" style="background:#e8eaf6">✈️</div><div class="dp-title">Paris → Lyon</div></div><div class="dp-subtitle">A/R · Economy</div></div><div class="dp-price-box"><div class="dp-price-big">378 €</div><div class="dp-price-info">126 €/p · 3 voy.</div></div></div>
        <div class="dp-section"><div class="dp-section-title">Itinéraire</div>
  ...
  'flight1-business': {
    ...
    html: `
      <div class="dp-content">
        <div class="dp-header"><div><div class="dp-title-row"><div class="dp-icon" style="background:#e8eaf6">✈️</div><div class="dp-title">Paris → Lyon</div></div><div class="dp-subtitle">A/R · Business</div></div><div class="dp-price-box"><div class="dp-price-big">1 140 €</div><div class="dp-price-info">380 €/p · 3 voy.</div></div></div>
        <div class="dp-section"><div class="dp-section-title">Itinéraire</div>
  ...
  flight2: {
    ...
    html: `
      <div class="dp-content">
        <div class="dp-header"><div><div class="dp-title-row"><div class="dp-icon" style="background:#fff3e0">✈️</div><div class="dp-title">Paris → Lyon</div></div><div class="dp-subtitle">A/R · Standard</div></div><div class="dp-price-box"><div class="dp-price-big">312 €</div><div class="dp-price-info">104 €/p · 3 voy.</div></div></div>
        <div class="dp-section"><div class="dp-section-title">Itinéraire</div>
