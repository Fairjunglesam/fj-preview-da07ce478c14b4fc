...
const panels = {
  train1: {
    ...
    html: `
      <div class="dp-content">
        <div class="dp-header"><div><div class="dp-title-row"><div class="dp-icon" style="background:#e3f2fd">🚄</div><div class="dp-title">Paris → Lyon</div></div><div class="dp-subtitle">Aller-retour · 2nde</div></div><div class="dp-price-box"><div class="dp-price-big">290 €</div><div class="dp-price-info">97 €/p · 3 voy.</div></div></div>
  ...
  'train1-1ere': {
    ...
    html: `
      <div class="dp-content">
        <div class="dp-header"><div><div class="dp-title-row"><div class="dp-icon" style="background:#e3f2fd">🚄</div><div class="dp-title">Paris → Lyon</div></div><div class="dp-subtitle">Aller-retour · 1ère Classe</div></div><div class="dp-price-box"><div class="dp-price-big">459 €</div><div class="dp-price-info">153 €/p · 3 voy.</div></div></div>
        <div class="dp-section"><div class="dp-section-title">Itinéraire</div>
  ...
  train2: {
    ...
    html: `
      <div class="dp-content">
        <div class="dp-header"><div><div class="dp-title-row"><div class="dp-icon" style="background:#e8f5e9">🚄</div><div class="dp-title">Paris → Lyon</div></div><div class="dp-subtitle">Aller-retour</div></div><div class="dp-price-box"><div class="dp-price-big">196 €</div><div class="dp-price-info">65 €/p · 3 voy.</div></div></div>
        <div class="dp-section"><div class="dp-section-title">Itinéraire</div>
  ...
  train3: {
    ...
    html: `
      <div class="dp-content">
        <div class="dp-header"><div><div class="dp-title-row"><div class="dp-icon" style="background:#e3f2fd">🚄</div><div class="dp-title">Paris → Lyon</div></div><div class="dp-subtitle">Aller-retour · 2nde</div></div><div class="dp-price-box"><div class="dp-price-big">318 €</div><div class="dp-price-info">106 €/p · 3 voy.</div></div></div>
        <div class="dp-section"><div class="dp-section-title">Itinéraire</div>
  ...
  'train3-1ere': {
    ...
    html: `
      <div class="dp-content">
        <div class="dp-header"><div><div class="dp-title-row"><div class="dp-icon" style="background:#e3f2fd">🚄</div><div class="dp-title">Paris → Lyon</div></div><div class="dp-subtitle">Aller-retour · 1ère Classe</div></div><div class="dp-price-box"><div class="dp-price-big">495 €</div><div class="dp-price-info">165 €/p · 3 voy.</div></div></div>
        <div class="dp-section"><div class="dp-section-title">Itinéraire</div>
  ...
  flight1: {
    ...
    html: `
      <div class="dp-content">
        <div class="dp-header"><div><div class="dp-title-row"><div class="dp-icon" style="background:#e8eaf6">✈️</div><div class="dp-title">Paris → Lyon</div></div><div class="dp-subtitle">Aller-retour · Economy</div></div><div class="dp-price-box"><div class="dp-price-big">378 €</div><div class="dp-price-info">126 €/p · 3 voy.</div></div></div>
        <div class="dp-section"><div class="dp-section-title">Itinéraire</div>
  ...
  'flight1-business': {
    ...
    html: `
      <div class="dp-content">
        <div class="dp-header"><div><div class="dp-title-row"><div class="dp-icon" style="background:#e8eaf6">✈️</div><div class="dp-title">Paris → Lyon</div></div><div class="dp-subtitle">Aller-retour · Business</div></div><div class="dp-price-box"><div class="dp-price-big">1 140 €</div><div class="dp-price-info">380 €/p · 3 voy.</div></div></div>
        <div class="dp-section"><div class="dp-section-title">Itinéraire</div>
  ...
  flight2: {
    ...
    html: `
      <div class="dp-content">
        <div class="dp-header"><div><div class="dp-title-row"><div class="dp-icon" style="background:#fff3e0">✈️</div><div class="dp-title">Paris → Lyon</div></div><div class="dp-subtitle">Aller-retour · Standard</div></div><div class="dp-price-box"><div class="dp-price-big">312 €</div><div class="dp-price-info">104 €/p · 3 voy.</div></div></div>
        <div class="dp-section"><div class="dp-section-title">Itinéraire</div>
...
panels['train1-out'] = {
  ...
  html: `
    <div class="dp-content">
      <div class="dp-header"><div><div class="dp-title-row"><div class="dp-icon" style="background:#e3f2fd">🚄</div><div class="dp-title">Paris → Lyon</div></div><div class="dp-subtitle">Aller · 2nde</div></div><div class="dp-price-box"><div class="dp-price-big">145 €</div><div class="dp-price-info">48 €/p · 3 voy.</div></div></div>
      <div class="dp-section"><div class="dp-section-title">Itinéraire</div>
...
panels['train1-out-1ere'] = {
  ...
  html: `
    <div class="dp-content">
      <div class="dp-header"><div><div class="dp-title-row"><div class="dp-icon" style="background:#e3f2fd">🚄</div><div class="dp-title">Paris → Lyon</div></div><div class="dp-subtitle">Aller · 1ère Classe</div></div><div class="dp-price-box"><div class="dp-price-big">230 €</div><div class="dp-price-info">77 €/p · 3 voy.</div></div></div>
      <div class="dp-section"><div class="dp-section-title">Itinéraire</div>
...
panels['train2-out'] = {
  ...
  html: `
    <div class="dp-content">
      <div class="dp-header"><div><div class="dp-title-row"><div class="dp-icon" style="background:#e8f5e9">🚄</div><div class="dp-title">Paris → Lyon</div></div><div class="dp-subtitle">Aller</div></div><div class="dp-price-box"><div class="dp-price-big">98 €</div><div class="dp-price-info">33 €/p · 3 voy.</div></div></div>
      <div class="dp-section"><div class="dp-section-title">Itinéraire</div>
...
panels['train3-out'] = {
  ...
  html: `
    <div class="dp-content">
      <div class="dp-header"><div><div class="dp-title-row"><div class="dp-icon" style="background:#e3f2fd">🚄</div><div class="dp-title">Paris → Lyon</div></div><div class="dp-subtitle">Aller · 2nde</div></div><div class="dp-price-box"><div class="dp-price-big">159 €</div><div class="dp-price-info">53 €/p · 3 voy.</div></div></div>
      <div class="dp-section"><div class="dp-section-title">Itinéraire</div>
...
panels['train3-out-1ere'] = {
  ...
  html: `
    <div class="dp-content">
      <div class="dp-header"><div><div class="dp-title-row"><div class="dp-icon" style="background:#e3f2fd">🚄</div><div class="dp-title">Paris → Lyon</div></div><div class="dp-subtitle">Aller · 1ère Classe</div></div><div class="dp-price-box"><div class="dp-price-big">248 €</div><div class="dp-price-info">83 €/p · 3 voy.</div></div></div>
      <div class="dp-section"><div class="dp-section-title">Itinéraire</div>
...
panels['train1-ret'] = {
  ...
  html: `
    <div class="dp-content">
      <div class="dp-header"><div><div class="dp-title-row"><div class="dp-icon" style="background:#e3f2fd">🚄</div><div class="dp-title">Lyon → Paris</div></div><div class="dp-subtitle">Retour · 2nde</div></div><div class="dp-price-box"><div class="dp-price-big">145 €</div><div class="dp-price-info">48 €/p · 3 voy.</div></div></div>
      <div class="dp-section"><div class="dp-section-title">Itinéraire</div>
...
panels['train1-ret-1ere'] = {
  ...
  html: `
    <div class="dp-content">
      <div class="dp-header"><div><div class="dp-title-row"><div class="dp-icon" style="background:#e3f2fd">🚄</div><div class="dp-title">Lyon → Paris</div></div><div class="dp-subtitle">Retour · 1ère Classe</div></div><div class="dp-price-box"><div class="dp-price-big">230 €</div><div class="dp-price-info">77 €/p · 3 voy.</div></div></div>
      <div class="dp-section"><div class="dp-section-title">Itinéraire</div>
...
panels['train2-ret'] = {
  ...
  html: `
    <div class="dp-content">
      <div class="dp-header"><div><div class="dp-title-row"><div class="dp-icon" style="background:#e3f2fd">🚄</div><div class="dp-title">Lyon → Paris</div></div><div class="dp-subtitle">Retour · 2nde</div></div><div class="dp-price-box"><div class="dp-price-big">159 €</div><div class="dp-price-info">53 €/p · 3 voy.</div></div></div>
      <div class="dp-section"><div class="dp-section-title">Itinéraire</div>
...
panels['train2-ret-1ere'] = {
  ...
  html: `
    <div class="dp-content">
      <div class="dp-header"><div><div class="dp-title-row"><div class="dp-icon" style="background:#e3f2fd">🚄</div><div class="dp-title">Lyon → Paris</div></div><div class="dp-subtitle">Retour · 1ère Classe</div></div><div class="dp-price-box"><div class="dp-price-big">248 €</div><div class="dp-price-info">83 €/p · 3 voy.</div></div></div>
      <div class="dp-section"><div class="dp-section-title">Itinéraire</div>
...
panels['train3-ret'] = {
  ...
  html: `
    <div class="dp-content">
      <div class="dp-header"><div><div class="dp-title-row"><div class="dp-icon" style="background:#e8f5e9">🚄</div><div class="dp-title">Lyon → Paris</div></div><div class="dp-subtitle">Retour</div></div><div class="dp-price-box"><div class="dp-price-big">98 €</div><div class="dp-price-info">33 €/p · 3 voy.</div></div></div>
      <div class="dp-section"><div class="dp-section-title">Itinéraire</div>
...
function toggleRecoDetail(id) {
  ...
  if (expandedRecoId === id) {
    ...
    // Smooth scroll: show the see-all bar + detail below it
    // Wait for slide-down animation (250ms) + layout to settle
    setTimeout(() => {
      const seeAllBar = document.querySelector('.d-reco-see-all');
      if (seeAllBar) {
        seeAllBar.scrollIntoView({ behavior: 'smooth', block: 'start' });
      }
    }, 300);
